...
Download to create fancy QR Codes with customized designs for your Facebook, Instagram, Pinterest, Youtube, whatsapp, personal website, contact card as well as to let others call you just by scanning your code.
[play store](https://play.google.com/store/apps/details?id=com.mayank.fancyqrcode)

## Privacy Policy

Your Privacy is very important to us.

[Mayank Kumar Chaudhari](https://mayank1513.github.io/) built the Fancy QR Code app as an Ad Supported as well as subscription based app. This SERVICE is provided by Mayank Kumar Chaudhari and is intended for use as is.

This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.

<figure>
  <script type="text/javascript">amzn_assoc_ad_type ="responsive_search_widget"; amzn_assoc_tracking_id ="mayank1513-21"; amzn_assoc_marketplace ="amazon"; amzn_assoc_region ="IN"; amzn_assoc_placement =""; amzn_assoc_search_type = "search_widget";amzn_assoc_width ="auto"; amzn_assoc_height ="auto"; amzn_assoc_default_search_category =""; amzn_assoc_default_search_key ="";amzn_assoc_theme ="light"; amzn_assoc_bg_color ="FFFFFF"; </script><script src="//z-in.amazon-adsystem.com/widgets/q?ServiceVersion=20070822&Operation=GetScript&ID=OneJS&WS=1&Marketplace=IN"></script>
</figure>


> ## Gist
> We collect and process data only through facebook sdk integration and google play developer console for sole purpose of displaying ads, processing purchases, crash analytics for improving performance and supporting features for social media integration.
>
